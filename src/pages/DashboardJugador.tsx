        ...
        <main className="p-8 pb-[60px] max-md:p-5 relative">
          ...
          <section className="grid grid-cols-4 max-lg:grid-cols-2 gap-[18px] mb-[26px]">
            {[
              ...
              { icon:'📅', num:'6', label:'Mis partidos', accent:'purple' },
              { icon:'⚽', num:'12', label:'Goles marcados', accent:'gold' },
            ].map((s, i) => (
          ...
          <section className="flex items-center justify-between gap-5 p-[26px_30px] rounded-[18px] bg-gradient-to-r from-purple-deep2 to-purple-black border border-white/10 max-md:flex-col max-md:items-start">
            <div>
              <h3 className="font-[family-name:var(--font-display)] uppercase text-xl leading-tight mb-1">Seguí a tu equipo</h3>
              <p className="text-[13px] text-text-muted">Mirá estadísticas, partidos y más.</p>
            </div>
            <InteractiveHoverButton onClick={() => navigate('/mis-partidos')}>
              Mis partidos
