      ...
      <AuroraBackground>
        <div className="relative w-full max-w-[1280px] mx-auto px-8 pt-[160px] pb-[100px] overflow-hidden">
          ...
          <div className="relative z-[2] text-center max-w-[600px] mx-auto">
            ...
            <motion.h1 initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{delay:0.3}} className="font-[family-name:var(--font-display-alt)] font-bold text-[clamp(42px,6vw,72px)] leading-[.92] tracking-[.5px] uppercase italic mb-4"><span className="text-gold">Contacto</span></motion.h1>
          </div>
        </div>
      </AuroraBackground>
