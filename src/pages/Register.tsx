                    ...
                    {googleVerified ? (
                      ...
                      <div className="mb-6 flex justify-center">
                        {import.meta.env.VITE_GOOGLE_CLIENT_ID ? (
                          ...
                          <button type="button" className="inline-flex items-center justify-center gap-3 rounded-full border border-gold/30 bg-purple-deep/30 text-gold-ink hover:bg-gold/10 hover:text-white h-12 px-6 text-sm font-semibold transition-all">
