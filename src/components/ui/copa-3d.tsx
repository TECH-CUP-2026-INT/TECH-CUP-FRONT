export function Copa3D() {
  return (
    <div className="relative w-full max-w-[300px] mx-auto aspect-[4/5] flex items-center justify-center select-none">
      ...
      <div
        className="relative w-[70%] aspect-[3/4] flex items-center justify-center"
      ...
      >
        <div
          ...
          style={{
            ...
            filter: 'drop-shadow(0 8px 30px rgba(200,133,26,0.35)) drop-shadow(0 2px 8px rgba(0,0,0,0.3))',
          }}
        />
        ...
        >
          <div
            ...
            style={{
              ...
              animation: 'copa-shimmer 4s ease-in-out infinite',
            }}
          />
        </div>
      </div>
